...
public class SuccessPanelController extends Controller {
	...
	public void onActionButtonClicked() {
		System.out.println("SuccessPanel - Starting navigation. NextScene: " + nextScene);
		System.out.println("SuccessPanel - PreviousScene: " + sceneNavigator.getPreviousScene());
		System.out.println("SuccessPanel - User logged in?: " + (restClient.getUser() != null));
