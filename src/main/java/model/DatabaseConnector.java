...
public class DatabaseConnector {
    ...
    // Define all database tables as constants based on the mapping provided
    public static final String COMPANIES = "space_companies";
    public static final String FLIGHTS = "space_flights";
    public static final String DATES = "dates";
    public static final String FLIGHT_SCHEDULES = "flight_schedules";
    public static final String FLIGHT_DATES = "flight_dates";
    public static final String RESERVATIONS = "reservations";
    public static final String SEAT_NUMBERS = "seat_numbers"; // seat numbers
    // -------------------------------------------------------------------
